...
/* blog/post.html.twig */
class __TwigTemplate_6698419026436f6c4c16309dae167fcdc16d73885062bb4432cab30a62bed568 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"post__category-img-container\">
        ...
        // line 10
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/alim.jpg"), "html", null, true);
        echo "\" alt=\"fruits\">
    </div>
    ...
    <article class=\"content\">
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 16, $this->source); })()), "postCategory", [], "any", false, false, false, 16), "catName", [], "any", false, false, false, 16), "html", null, true);
        echo " \\</a></span>
            <h1 class=\"content__title post__title\">";
        // line 17
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 17, $this->source); })()), "postTitle", [], "any", false, false, false, 17), "html", null, true);
        echo "</h1>
        </div>
        ...
        // line 23
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 23, $this->source); })()), "postImg", [], "any", false, false, false, 23), "html", null, true);
        echo "\" alt=\"plat sain\">
                </div>
                <p>";
        // line 25
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 25, $this->source); })()), "postContent", [], "any", false, false, false, 25), "html", null, true);
        echo "</p>
        </div>
...
";
    ...
    {
        return array (  141 => 25,  136 => 23,  127 => 17,  121 => 16,  112 => 10,  108 => 8,  98 => 7,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"post__category-img-container\">
        <img class=\"post__category-img\" src=\"{{ asset('img/alim.jpg') }}\" alt=\"fruits\">
    </div>
    ...
    <article class=\"content\">
        ...
        <section>
            <div class=\"preview__container\">
                <div class=\"preview__img\">
                    <img class=\"img__content post__img\" src=\"{{post.postImg}}\" alt=\"plat sain\">
                </div>
