...
/* blog/blog.html.twig */
class __TwigTemplate_e02db92f006e60d3ffdcd389535422fb29db5dfa311c3e6a752dd2f3a59f3cb6 extends Template
{
    private $source;
    private $macros = [];
...
$context["loop"], "index", [], "any", false, false, false, 19), 3))) {
    ...
    <article class=\"content\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
            ...
            echo "                <div class=\"preview__container\">
                    ...
                    <div class=\"preview__img\">
                        <a href=\"";
            // line 41
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("post", ["slug" => twig_get_attribute($this->env, $this->source, $context["post"], "slug", [], "any", false, false, false, 41)]), "html", null, true);
            echo "\"><img class=\"img__content\" src=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "postImg", [], "any", false, false, false, 41), "html", null, true);
            echo "\" alt=\"plat sain\"></a>
                    </div>

                    <span class=\"category__indicator\"><a class=\"category__link\" href=\"";
            // line 44
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("category", ["slug" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["post"], "postCategory", [], "any", false, false, false, 44), "slug", [], "any", false, false, false, 44)]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["post"], "postCategory", [], "any", false, false, false, 44), "catName", [], "any", false, false, false, 44), "html", null, true);
            echo "</a></span>
            ...
            echo "</a></h4>
                    ...
                    <p>";
            // line 48
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $this->extensions['Twig\Extra\String\StringExtension']->createUnicodeString(twig_get_attribute($this->env, $this->source, $context["post"], "postContent", [], "any", false, false, false, 48)), "truncate", [0 => 200], "method", false, false, false, 48), "html", null, true);
            echo "...</p>
        ...
        <div class=\"navigation\">
            ";
        // line 55
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["lastPosts"]) || array_key_exists("lastPosts", $context) ? $context["lastPosts"] : (function () { throw new RuntimeError('Variable "lastPosts" does not exist.', 55, $this->source); })()));
        echo "
        </div>
...
";
    ...
    {
        return array (  217 => 55,  212 => 52,  202 => 48,  195 => 46,  188 => 44,  180 => 41,  175 => 38,  171 => 37,  162 => 30,  143 => 25,  139 => 24,  135 => 23,  132 => 22,  128 => 20,  126 => 19,  123 => 18,  121 => 17,  118 => 16,  115 => 15,  98 => 14,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
        ...
        <section>
            {% for post in lastPosts %}
                <div class=\"preview__container\">
                    ...
                    <div class=\"preview__img\">
                        <a href=\"{{ path('post', {slug: post.slug}) }}\"><img class=\"img__content\" src=\"{{ post.postImg }}\" alt=\"plat sain\"></a>
                    </div>
