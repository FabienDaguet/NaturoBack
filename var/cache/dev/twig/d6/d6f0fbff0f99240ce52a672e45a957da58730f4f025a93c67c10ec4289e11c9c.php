...
class __TwigTemplate_d8d92b97867f74e00013e548438dda61e7f6ee1185dff4e8434ec13956579372 extends Template
{
    ...
    public function block_page_title($context, array $blocks = [])
    {
        ...
        echo "Bienvenue dans votre back office";
    ...
    public function block_page_content($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["allCategory"]) || array_key_exists("allCategory", $context) ? $context["allCategory"] : (function () { throw new RuntimeError('Variable "allCategory" does not exist.', 9, $this->source); })()));
        $context['loop'] = [
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            // line 10
            echo "                ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 10), 1))) {
                // line 11
                echo "                <div class=\"col-4 alert-success\">
                ";
            } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source,             // line 12
$context["loop"], "index", [], "any", false, false, false, 12), 2))) {
                // line 13
                echo "                <div class=\"col-4 alert-primary\">
                ";
            } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source,             // line 14
$context["loop"], "index", [], "any", false, false, false, 14), 3))) {
                // line 15
                echo "                <div class=\"col-4 alert-warning\">   
                ";
            }
            // line 17
            echo "                    <div class=\"h1\">";
...
{% block page_title 'Bienvenue dans votre back office' %}
