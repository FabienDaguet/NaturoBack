...
class __TwigTemplate_f68605350a747ab846849e8b954e0213b1aaa0d00bee66c86cc35956e9847146 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_history($context, array $blocks = [])
    {
        ...
        echo "\" class=\"p-3 nav-link text-decoration-none link\" id=\"active\">Un peu d'histoire</a>";
...
";
    ...
    {
        return array (  110 => 8,  100 => 7,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% block history %}<a href=\"{{ path('history') }}\" class=\"p-3 nav-link text-decoration-none link\" id=\"active\">Un peu d'histoire</a>{% endblock %}
